import { ArrowRight, Wrench, Zap, Droplets, Thermometer, Wind } from 'lucide-react';
  ...
  const services = [
    {
      ...
      icon: FaSnowflake,
      title: 'AC Services',
      description: 'Complete air conditioning solutions for all domestic AC types',
      features: ['Repair & Installation', 'Gas Filling', 'Regular Maintenance', 'Second-hand Buy/Sell'],
    ...
    },
    {
      ...
      features: ['Cooling Issues', 'Compressor Repair', 'Temperature Control', 'Ice Maker Repair'],
    ...
    },
    {
      ...
      features: ['Drum Repair', 'Motor Issues', 'Water Leakage', 'Spin Problems'],
    ...
    },
    {
      ...
      features: ['Filter Replacement', 'Installation', 'Water Quality Testing', 'Maintenance'],
    ...
    },
    {
      ...
      features: ['Element Replacement', 'Thermostat Repair', 'Tank Cleaning', 'Installation'],
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            We provide comprehensive home appliance services with expert technicians, 
            genuine parts, and guaranteed satisfaction.
          </p>
        </div>
          ...
          <div className="glass-strong p-8 rounded-3xl glow max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                ...
                onClick={() => {
                  const phone = "+917338965589";
                  const message = "Hi, I need appliance repair service. Please help!";
                  window.open(`https://wa.me/${phone}?text=${encodeURIComponent(message)}`, '_blank');
                }}
              >
                WhatsApp Now
